...
class UserCard extends HTMLElement {
  constructor() {
    ...
    // Define the attributes to be set (like props)
    this.h3 = this.shadowRoot.querySelector('h3')
    this.avatar = this.shadowRoot.querySelector('img')
  }

  // Note: Why we use this getter instead of `getAttribute()` 
  // in the constructor: https://stackoverflow.com/q/70201172
  static get observedAttributes() { return ['name', 'avatar']; }

  attributeChangedCallback(name, _, newValue) {
    if(name === 'name') {      
      return this.h3.innerText = newValue
    }

    if(name == 'avatar') {
      return this.avatar.src = newValue
    }
  }
